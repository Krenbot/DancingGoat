...
[assembly: UIApplication(
    SampleDataGeneratorApplication.IDENTIFIER,
    typeof(SampleDataGeneratorApplication),
    "sample-data-generator",
    "Sample data generator",
    BaseApplicationCategories.CONFIGURATION,
    Icons.CogwheelSquare,
    TemplateNames.OVERVIEW
)]
    ...
    public class SampleDataGeneratorApplication : OverviewPageBase
    {
        ...
        public async Task<ICommandResponse> GenerateGdprSampleData()
        {
            try
            {
                ...
                new FormConsentGenerator(
                    formBuilderConfigurationSerializer,
                    consentInfoProvider,
                    bizFormInfoProvider
            ...
            catch (Exception ex)
            {
                ...
                return Response()
                    .AddErrorMessage(
                        "GDPR sample data generator failed. See event log for more details."
                    );
            }
        ...
        {
            var dataProtectionSamplesEnabledSettingsKey = settingsKeyInfoProvider.Get(
                DATA_PROTECTION_SETTINGS_KEY
            );
        ...
        private OverviewCard GetGdprCard()
        {
            return new OverviewCard
            {
                ...
                Components = new List<IOverviewCardComponent>()
                {
                    ...
                    {
                        Content =
                            @"Generates data and enables demonstration of giving consents, personal data portability, right to access, and right to be forgotten features.
        ...
        private async Task SetChannelDefaultCookieLevelToEssential(int websiteChannelId)
        {
            ...
            {
                websiteChannel.WebsiteChannelDefaultCookieLevel = Kentico
                    .Web
                    .Mvc
                    .CookieLevel
                    .Essential
