...
{
    services
        .AddIdentity<ApplicationUser, NoOpApplicationRole>(options =>
        {
    ...
    services.ConfigureApplicationCookie(options =>
    {
        ...
        options.Events.OnRedirectToAccessDenied = ctx =>
        {
            ...
            var urlHelper = factory.GetUrlHelper(
                new ActionContext(
                    ctx.HttpContext,
                    new RouteData(ctx.HttpContext.Request.RouteValues),
    ...
    services.Configure<AdminIdentityOptions>(options =>
    {
        ...
        var companySpecificKeywords = new List<string>
        {
            "kentico",
            "dancinggoat",
            "admin",
        ...
        options.PasswordOptions.ForbiddenPasswords = ForbiddenPasswordGenerator.Generate(
            companySpecificKeywords,
            specificNumberCombinations
        );
    });
